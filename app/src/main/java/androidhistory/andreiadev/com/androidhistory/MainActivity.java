...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridViewAndroidVersions = (GridView) this.findViewById(R.id.gv_android_versions);
        gridViewAndroidVersions.setAdapter(new AndroidVersionsAdapter(this, this.getAndroidVersionsMock()));
    }
